document.addEventListener('DOMContentLoaded', function () {
    ...
    function editItem(type, id, field, value) {
        ...
        if (type === 'menu') {
            ...
            const description = field === 'description' ? value : document.getElementById(`description-${id}`).textContent.trim();
            const price = field === 'price' ? value : parseFloat(document.getElementById(`price-${id}`).textContent.replace('$', '').trim());
        ...
        function handleProfileUpdate(event) {
            ...
            .then(data => {
                if (data.errors) {
                    ...
                    if (fieldName === 'email') {
                        alert('Link weryfikacyjny został wysłany na nowy adres e-mail. Zmiana zostanie zatwierdzona po weryfikacji.');
                    } else if (fieldName === 'phoneNumber') {
                        alert('Kod weryfikacyjny został wysłany na nowy numer telefonu. Zmiana zostanie zatwierdzona po weryfikacji.');
                    } else {
