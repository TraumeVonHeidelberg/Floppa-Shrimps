...
// Asocjacje dla News i NewsHeaderText
News.hasMany(NewsHeaderText, { foreignKey: 'newsId', as: 'headers' }); // Unikalny alias 'headers'
NewsHeaderText.belongsTo(News, { foreignKey: 'newsId', as: 'news' }); // Unikalny alias 'news'
